...
function Customer() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const vegetablesResponse = await axios.get(
          `${process.env.REACT_APP_BACKEND_URL}/api/vegetables`
        );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const fruitsResponse = await axios.get(
          `${process.env.REACT_APP_BACKEND_URL}/api/fruits`
        );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const dairyResponse = await axios.get(
          `${process.env.REACT_APP_BACKEND_URL}/api/dairy`
        );
